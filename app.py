...
# que es el mecanismo propio de Streamlit. Acá solo queda el estilo del botón
# de anular cuando un pedido quedó sin insumos: es un detalle que el tema no
# puede expresar. Se evita a propósito tocar fondos y textos por CSS, porque
# eso pisaba los estilos internos y dejaba el modo claro con partes oscuras.
st.markdown(
    """
    <style>
      @keyframes latido {
